...
Output appears in `data/processed/result_parquet/`. Validation report regenerates at `doc/validation.md`.
...
│   └── main.py                 # entry point
├── data/
│   ├── README.md               # how to populate raw/ from external sources
...
See [`doc/data_dictionary.md`](doc/data_dictionary.md) for full column-by-column documentation.
</details>
